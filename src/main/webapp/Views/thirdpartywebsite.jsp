...
<section class="content">
    ...
    <header class="top-head container-fluid">
        <div style="text-align: center;display: flex; justify-content: space-between; margin-top: 0px;">
            <h3 style="font-weight: bold;margin-top: 14px;font-size: 18px;  text-transform: uppercase;margin-bottom: 0;">Third Party Websites            </h3>
            ...
            <li class="dropdown text-center">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="username"></span> <span class="caret">Admin</span>
                </a>
...
<div class="container form-panel">
    ...
    <div class="col-md-8">
        <form action="/crm-admin/addthirdpartyurl" method="post" enctype="multipart/form-data" name="request">
          ...
          <table id = "thirdpartywebsites" class="table table-striped table-responsive-sm">
              ...
              <tbody>
               <c:forEach items = "${active}" var = "thirdweb">
                  <tr>
                      <th>${thirdweb.webId}</th>
                      <td><p style="width: 450px; overflow: auto">${thirdweb.webUrl}</p></td>
                      <td><img height="50px" width= "50px" src="data:image/jpg;base64,${thirdweb.webImage}"> </td>
                      <td class="status">${thirdweb.status}</td>
                      <td>
                        <button type="button" style="background: #315ea2" class="btn btn-info" data-toggle="modal" data-target="#${thirdweb.webId}update">
                          Update
                        </button>
                        <button type="button" style="background: red" class="btn btn-info" data-toggle="modal" data-target="#${thirdweb.webId}delete">
                         Delete
                        </button>
                  </tr>
                  </c:forEach>    
                   <c:forEach items = "${inactive}" var = "thirdweb">
                  <tr>
                      <th>${thirdweb.webId}</th>
                      <td><p style="width: 450px; overflow: auto">${thirdweb.webUrl}</p></td>
                      <td><img height="50px" width= "50px" src="data:image/jpg;base64,${thirdweb.webImage}"> </td>
...
<!-- update form -->
<c:forEach items = "${active}" var = "thirdweb"> 
<div class="modal fade" id="${thirdweb.webId}update" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form 
              action="/crm-admin/updatethirdpartyurl"
              method="post"
              enctype="multipart/form-data"
              name = "request"> 
                 <div class="modal-content">
                      <div class="form-group">
                          <input type="text" name="webId" value="${thirdweb.webId}" hidden>
                          <label for="inputdefault">Third party website (URL)</label>
                          <input class="form-control" type="text" name= "webUrl" value="${thirdweb.webUrl}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name = "status">
                              <option value="Active" selected>${thirdweb.status}</option>
...
<c:forEach items = "${active}" var = "thirdweb"> 
<div class="modal fade" id="${thirdweb.webId}delete" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document" style="vertical-align: middle;">
        <div class="modal-content">
            <form action="/crm-admin/deletethirdpartyurl" method="post"  name = deleteRequest>
               <div class="modal-content">
...
<div class="modal fade" id="${thirdweb.webId}delete" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document" style="vertical-align: middle;">
        <div class="modal-content">
            <form action="/crm-admin/deletethirdpartyurl" method="post">
               <div class="modal-content">
                    <div style="text-align:center;">               
                        <input type="text" name="webId" value="${thirdweb.webId}" hidden>
                        <button 
